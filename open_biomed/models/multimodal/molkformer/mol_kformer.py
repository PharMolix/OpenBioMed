...
from models.multimodal.molkformer.kformer import BertConfig, BertLMHeadModel
from utils.mol_utils import convert_pyg_batch, get_biot5_tokenizer
...
class MolKFormer(MolEncoder, TextEncoder):
    def __init__(self, config):
        ...
        self.decoder_tokenizer = get_biot5_tokenizer(config["decoder_tokenizer"], config["path_selfies"])
    ...
    def get_graph_feats(self, graph, batch_size):
        ...
        # batch = graph.batch
        # a = self.pooling(node_embeds, batch)
