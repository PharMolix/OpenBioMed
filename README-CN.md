...
文章列表：    
[01. 超详细教程：如何在笔记本上run起大模型？没有GPU也可以！（Windows/Mac）](https://tpd5babpju.feishu.cn/docx/LSI2dLQgNoz6huxtzobcc40rngg) | [示例代码](./examples/course/01_run_biomedgpt_lm_on_your_computer.ipynb)
